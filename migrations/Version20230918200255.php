 ...
 */
final class Version20230918200255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE route_station (id INT AUTO_INCREMENT NOT NULL, route_id INT NOT NULL, station_id INT NOT NULL, route_order INT NOT NULL, INDEX IDX_676AA52934ECB4E6 (route_id), INDEX IDX_676AA52921BDB235 (station_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ticket_price ADD CONSTRAINT FK_E2F8415234ECB4E6 FOREIGN KEY (route_id) REFERENCES route (id)');
        $this->addSql('ALTER TABLE ticket_price ADD CONSTRAINT FK_E2F84152FF134AA1 FOREIGN KEY (departure_station_id) REFERENCES station (id)');
        $this->addSql('ALTER TABLE ticket_price ADD CONSTRAINT FK_E2F84152766102BE FOREIGN KEY (arrival_station_id) REFERENCES station (id)');
    }
